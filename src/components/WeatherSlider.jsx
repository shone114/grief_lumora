...
const WeatherSlider = () => {
    ...
    return (
        <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-[100] bg-black/20 backdrop-blur-md rounded-full px-6 py-3 flex gap-6 border border-white/10 shadow-lg">
            {moods.map((m) => (
                <button
                    key={m.id}
